...
export default function HeroSection() {
  return (
    ...
    <div className="relative flex flex-col px-10 max-w-300 m-auto items-center justify-center mt-30">
      ...
      <div className="flex gap-4 flex-col items-center text-center md:flex-row flex-nowrap text-sm">
          <a href="#product" className={`border block drop-shadow-lg text-center hover:drop-shadow-lg hover:drop-shadow-white/20 drop-shadow-white/10 text-nowrap cursor-pointer border-solid md:text-[16px] bg-white/70 py-3 px-6 rounded-xl font-semibold text-black`}>Discover Our Product</a>
          <a href="https://t.me/+PDthiNCZhTlmYTJk" target="_blank"  className={`cursor-pointer text-center z-3 block hover:bg-white/10 font-light text-white text-nowrap md:text-[16px] py-3 px-6 rounded-xl bg-black/40 border border-white/20 `}>Join the Academy</a>
      </div>
      </div>
    </div>
  </>
